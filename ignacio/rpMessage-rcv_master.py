...
processingAppPath = "/home/pi/sketchbook/Ignacio_v1/application.linux-armv6hf/Ignacio_v1"

videoPath = "/home/pi/Desktop/bigscreen.mp4"  
# --adev local specifies the audio device used, here it is headphones     
subprocess.Popen("omxplayer --loop --no-osd --adev local --vol -600 " + videoPath, shell=True)
time.sleep(3)
subprocess.call([dBus_scriptPath + ' setvideopos 300 300 920 1080'], shell=True)
time.sleep(1)
